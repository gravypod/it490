...
class Location(object):
    ...
    def x(self, x):
        ...
        :type: float
        """
        if x is not None and x > 6400:  # noqa: E501
            raise ValueError("Invalid value for `x`, must be a value less than or equal to `6400`")  # noqa: E501
    ...
    def y(self, y):
        ...
        :type: float
        """
        if y is not None and y > 6400:  # noqa: E501
            raise ValueError("Invalid value for `y`, must be a value less than or equal to `6400`")  # noqa: E501
